...
<Note>
  If you scaffolded or upgraded your project with the [Openinary
  CLI](/quickstart), a 64-character `API_SECRET` is already generated for you in
  `.env`, you can skip straight to step 2.
</Note>
