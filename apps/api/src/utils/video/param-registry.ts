...
) => FfmpegCommand | Promise<FfmpegCommand>;
...
export const VIDEO_PARAMS: readonly VideoParamDefinition[] = [
  {
    ...
    name: "Thumbnail",
    description:
      "Extracts a single frame as an image thumbnail. When enabled, the output will be an image format (jpg, png, webp, etc.) instead of a video.",
    example: "t_true",
    defaultValue: false,
  ...
  },
  {
    ...
    name: "Thumbnail Time",
    description:
      "Specifies the time (in seconds) from which to extract the thumbnail. Works in conjunction with the thumbnail parameter.",
    example: "tt_5.5",
    defaultValue: 0,
  ...
  },
  {
    ...
    name: "Start Offset",
    description:
      "Trims the video by starting from the specified time in seconds. Can be used alone or with end offset.",
    example: "so_10",
    validValues: ["any positive number (seconds)"],
  ...
  },
  {
    ...
    name: "End Offset",
    description:
      "Trims the video by ending at the specified time in seconds. If used with start offset, creates a segment between the two times.",
    example: "eo_30",
    validValues: ["any positive number (seconds)"],
  ...
  },
  {
    ...
    name: "Width",
    description:
      "Sets the width of the video in pixels. Should be used with height for proper scaling.",
    example: "w_1280",
  ...
  },
  {
    ...
    name: "Height",
    description:
      "Sets the height of the video in pixels. Should be used with width for proper scaling.",
    example: "h_720",
    validValues: ["any positive integer"],
    processor: (command, _value, context) => {
  ...
  },
  {
    ...
    name: "Resize",
    description:
      "Specifies dimensions in WxH format (e.g., 1280x720). Alternative to using separate width and height parameters.",
    example: "r_1920x1080",
  ...
  },
  {
    ...
    name: "Crop Mode",
    description:
      "Defines how the video should be resized. Options: fill/crop (cover entire area with cropping, no stretching), fit (fit within dimensions maintaining aspect ratio), scale (exact dimensions, may stretch), pad (fit within dimensions and pad with background).",
    example: "c_fill",
    defaultValue: "fill",
  ...
  },
  {
    ...
    name: "Gravity",
    description:
      "Defines the focal point when cropping (future support). Options: center (center), north (top), south (bottom), east (right), west (left), auto (entropy-based).",
    example: "g_center",
    defaultValue: "center",
  ...
  },
  {
    ...
    name: "Quality",
    description:
      "Sets the quality of the output video (0-100). Uses CRF (Constant Rate Factor) encoding. Higher values produce better quality and larger files. Quality 100 ≈ CRF 18, Quality 50 ≈ CRF 28.",
    example: "q_80",
  ...
  },
  {
    ...
    name: "Format",
    description:
      "Specifies the output format. Video formats: mp4, mov, webm. Image formats (for thumbnails): jpg, jpeg, png, webp, avif, gif. If not specified, defaults to mp4 for videos or jpg for thumbnails.",
    example: "f_webm",
    defaultValue: "mp4",
    validValues: [
      "mp4",
 ...
 */
export const applyResizeComposite = async (
  command: FfmpegCommand,
  context: VideoContext,
 ...
 */
export const getVideoParamDefinition = (
  param: string,
): VideoParamDefinition | undefined => {
  return VIDEO_PARAMS.find(
 ...
 */
export const getVideoParamDefault = (
  param: string,
 ...
 */
export const isValidVideoParamValue = (
  param: string,
  value: string,
): boolean => {
  const def = getVideoParamDefinition(param);
