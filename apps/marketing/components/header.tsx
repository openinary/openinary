...
export function Header() {
  ...
  return (
    ...
    >
      ...
      >
        <Link
          className="rounded-md p-1 transition-all hover:bg-muted dark:hover:bg-muted/50"
          href="/"
        ...
        <div className="flex items-center gap-2">
          ...
          <Link target="_blank" href="https://github.com/openinary/openinary">
            ...
            >
              ...
              <span className="tabular-nums [&_.char-slot]:leading-[1]">
                {counterDone ? (
                  <SlotText
                    text={String(
                      isHovered ? (starCount ?? 0) + 1 : (starCount ?? 0),
                    )}
                    options={{
                      direction: isHovered ? "up" : "down",
                      ...(isHovered && { color: chromatic({ from: 190 }) }),
                    }}
                  />
                ) : (
                  <AnimatedCounter
