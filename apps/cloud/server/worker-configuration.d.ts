/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 82cda7ce11a84f4b37105a15465bdc2f)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
  BUCKET_OWNERS: KVNamespace;
  MEDIA_BUCKET: R2Bucket;
  CDN_RATE_LIMITER: RateLimit;
  ...
  MEDIA_CONTAINER: DurableObjectNamespace<
    import("./worker/index").MediaContainer
  >;
  USAGE_METER: DurableObjectNamespace<import("./worker/index").UsageMeter>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./worker/index");
    durableNamespaces: "MediaContainer" | "UsageMeter";
  }
