...
// shadcn also ships an InputOTPSeparator for split groups (3-3). The sign-in
// code is one group of six, so it isn't here - re-add it from the registry if
// a split layout ever shows up.
