...
<ParamField path="API_SECRET" type="string">
  Secret used to sign and verify [signed URLs](/media-transformations/signed-urls) and presigned, authenticated uploads (see the [File Uploader](/guides/file-uploader)). Required if you use the `/authenticated/*` route or presigned uploads. Must be 64 characters.
