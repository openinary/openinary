...
<Steps>
  <Step title="Request access">
    On [openinary.dev](https://openinary.dev), click **Request Cloud access** and leave your email address.
  </Step>
  <Step title="Wait for the invite email">
    When your account is opened you receive _"Your Openinary account is ready"_ with a sign-in link, valid for 24 hours. Clicking it signs you in at [app.openinary.dev](https://app.openinary.dev).
  </Step>
  <Step title="Sign back in later">
    From [app.openinary.dev](https://app.openinary.dev), enter your email to get a **6-digit code** (valid 10 minutes), or use **Google**. There is no password.
  </Step>
</Steps>
