...
- `API_SECRET` set on the instance (**minimum 16 characters**) — used internally to compute the HMAC signature. Same secret used for [signed delivery URLs](/media-transformations/signed-urls).
